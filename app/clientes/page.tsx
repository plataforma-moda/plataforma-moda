...
const segmentos = [
  'Matéria-prima','Indústria Têxtil','Confecção','Desenvolvimento',
  'Distribuição','Comercialização','Serviços de apoio','Ecossistema'
]
  ...
  if (sucesso) return (
    <main style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', padding: '60px 20px', textAlign: 'center' }}>
      ...
      <p style={{ color: '#666', marginBottom: '30px' }}>
        Bem-vindo, <strong>{form.nome}</strong>! Agora você pode buscar fornecedores e enviar pedidos de cotação.
      </p>
  ...
  return (
    <main style={{ fontFamily: 'Arial, sans-serif', maxWidth: '700px', margin: '0 auto', padding: '20px' }}>
      <header style={{ padding: '30px 0', borderBottom: '1px solid #eee', marginBottom: '30px' }}>
        ...
        <p style={{ color: '#666', marginTop: '6px' }}>Encontre os fornecedores certos para o seu negócio</p>
      </header>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={sec}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '16px' }}>
            ...
            <div><label style={lbl}>Cidade</label><input name="cidade" value={form.cidade} onChange={handleChange} placeholder="Ex: São Paulo" style={inp} /></div>
          </div>
        </div>
        ...
        {erro && (
          <div style={{ padding: '12px', backgroundColor: '#FCEBEB', border: '1px solid #F09595', borderRadius: '8px', marginBottom: '16px', color: '#791F1F', fontSize: '14px' }}>
            {erro}
          </div>
        )}
